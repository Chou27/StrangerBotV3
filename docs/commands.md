# Commands  
Here's the list of strangerbot commands. This one contains more than **110 commands** in **8 categories**!  
...
| ---------------- | ------------------------------------------------------------------------ | ------------------------------ | --------- |
| **api-token**    | Send your token back to use the strangerbot API!                             | apitoken (regenerate)          | 1 seconds |
...
| **github**       | Displays the information from the strangerbot github!                        | github                         | 5 seconds |
...
| **invite**       | Displays the links of strangerbot!                                           | invite (copy)                  | 5 seconds |
| **minecraft**    | Displays information about the Minecraft server!                         | minecraft [ip]                 | 3 seconds |
| **partners**     | Displays strangerbot partners                                                | partners                       | 1 seconds |
