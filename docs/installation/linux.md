...
2. Clone this repository with `git clone https://github.com/Androz2091/strangerbotBot.git`.
3. Run `cd strangerbotBot` to move in the folder that Git has just created.
...
For emojis, you must add them on one of your bot's servers and enter the string of the emoji (<:emojiName:emojiID>). If you are lazy to add them, you can join [**this server**](https://emojis.strangerbot-bot.fr) on which you will only have to add your bot to access a bank of emojis!
...
2. Run `pm2 start strangerbot.js` to run the bot.
3. Enjoy it!
