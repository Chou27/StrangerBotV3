module.exports = {
	...
	dashboard: {
		...
		baseURL: "https://dashboard.strangerbot-bot.fr", // The base URl of the dashboard
		logs: "XXXXXXXXXXX", // The channel ID of logs
		port: 8080, // Dashboard port
		expressSessionPassword: "XXXXXXXXXXX", // Express session password (it can be what you want)
		failureURL: "https://www.strangerbot-bot.fr" // url on which users will be redirected if they click the cancel button (discord authentication)
	},
	mongoDB: "mongodb://localhost:27017/strangerbotBot", // The URl of the mongodb database
	prefix: "*", // The default prefix for the bot
	/* For the embeds (embeded messages) */
	embed: {
		color: "#0091fc", // The default color for the embeds
		footer: "strangerbot | Open Source" // And the default footer for the embeds
	},
	defaultLanguage: "english", // The default language for the new servers
	botname: "strangerbot", // The name of the bot
	...
	badges: {
		...
		others: [
			...
			{ name:"strangerbot", emoji: "XXXXXXXXXXX", price: 1200 },
	...
	status: [
		{
			name: "@strangerbot help on {serversCount} servers",
			type: "LISTENING"
		},
		{
			name: "my website : strangerbot-bot.fr",
			type: "PLAYING"
		}
	],
