...
module.exports = class {
    constructor() {
		this.language = {
			...
			VOTE_LOGS: (user) => `:arrow_up: **${user.tag}** (\`${user.id}\`) voted for **strangerbot** and won **40** credits, thank you!\nhttps://discordbots.org/bot/557445719892688897/vote`,
			...
			// Content
			GITHUB_DESC: `[Click here to access the github of ${c.botname}](https://github.com/Androz2091/strangerbotBot)`,
			// Headings
			GITHUB_HEADERS: [
				"Stars :star:",
				"Forks :tools:",
			...
			ACHIEVEMENTS_DESC: [
				...
				"Keep strangerbot alive by tipping!",
				"Reach 20 reputation points!",
				"Invite strangerbot on your server!"
			],
			...
			EIGHTBALL_EXAMPLES: "$8ball Is strangerbot the best Discord bot?",
			// Errors
			...
			// Utils
			APITOKEN_DESCRIPTION: "Send your token back to use the strangerbot API!",
			...
			// Utils
			PARTNERS_DESCRIPTION: "Displays strangerbot partners",
