...
module.exports = class {
    constructor() {
		this.language = {
			...
			VOTE_LOGS: (user) => `:arrow_up: **${user.tag}** (\`${user.id}\`) a voté pour **strangerbot** et a gagné **40** crédits, merci !\nhttps://discordbots.org/bot/557445719892688897/vote`,
			...
			// Content
			GITHUB_DESC: `[Cliquez ici pour accéder au github d'${c.botname}](https://github.com/Androz2091/strangerbotBot)`,
			// Headings
			GITHUB_HEADERS: [
				"Stars :star:",
				"Forks :tools:",
			...
			ACHIEVEMENTS_DESC: [
				...
				"Maintenez strangerbot en vie en laissant un pourboire!",
				"Atteignez 20 points de réputation !",
				"Invitez strangerbot sur votre serveur !"
			],
			...
			SERVERINFO_EXAMPLES: "$serverinfo strangerbot\n$serverinfo",
			// Content
			// Headings
			SERVERINFO_HEADINGS:[
				`${e.title} Nom`,
			...
			GETINVITE_EXAMPLES: "$getinvite strangerbot\n$getinvite 565048515357835264",
			// Errors
			...
			EIGHTBALL_EXAMPLES: "$8ball Est-ce qu'strangerbot est le meilleur bot Discord ?",
			// Errors
			...
			// Utils
			APITOKEN_DESCRIPTION: "Renvoie votre token pour utiliser l'API d'strangerbot !",
			...
			// Utils
			PARTNERS_DESCRIPTION: "Affiche les partenaires d'strangerbot",
